 ...
 */
/*The class uses the concept of Generics, as evident from Adapter<E>. E here stands for Element, and it can be any type,
allowing for a flexible and type-safe way of handling objects.
 */
public class Adapter<E> implements JsonSerializer<E>, JsonDeserializer<E>{
    ...
    public E deserialize(JsonElement json, Type typeOfT,
        ...
        if (prim == null) {
            throw new JsonParseException("Cannot find classname for deserialization");
        }
